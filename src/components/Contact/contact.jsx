...
const SOCIALS = [
  {
    label: "Twitter",
    href: "https://twitter.com/moazzam35",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/no_one_live_there/",
      ...
      <div className="footer-inner">
        <div className="footer-top">
          <div className="footer-info">
            ...
            <a href="mailto:moazzampasha356@gmail.com" className="footer-email">
          ...
          <form className="footer-form" onSubmit={handleSubmit} aria-label="Contact form">
            ...
            />
            <button type="submit" className="footer-send" disabled={status === "sending"}>
        ...
        <div className="footer-bottom">
          ...
          <p className="footer-copy">
            &copy; {new Date().getFullYear()} Moazzam Pasha. All rights
            reserved.
          </p>
        </div>
      </div>
