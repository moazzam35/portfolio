...
function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "ShopCraft E-Commerce Store",
      description:
        "A fully functional e-commerce web application built with React.js, featuring product catalog, shopping cart, checkout flow, and advanced filtering with real-time API integration and responsive design.",
      tags: ["React.js", "JavaScript", "Payments", "User Friendly"],
      demoLink: "https://moazzam35.github.io/ShopCraft/#/",
      codeLink: "https://github.com/moazzam35/ShopCraft",
    ...
    },
    {
      ...
      title: "Country Cards",
      description:
        "An interactive application that fetches and displays country data with detailed information including flags, population, regions, and more with beautiful card layouts.",
      ...
      <div className="projects-container">
        <div className="projects-header">
          <span className="projects-badge" data-aos="fade-down">
            <span className="badge-icon"><FaBagShopping style = {{color : "#ca9f83"}}/></span>
            My Projects
          </span>
          <h2 data-aos="fade-up">
          ...
          <p data-aos="fade-up" data-aos-delay="100">
            Building interactive applications with real-time data fetching and
            modern design
          </p>
        </div>
